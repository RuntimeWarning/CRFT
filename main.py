...
from configs.configs import configs, str2bool
...
dataset_name = args.datasets.split("_")[0]
args.thresholds = [16, 74, 133, 160, 181, 219] if dataset_name == 'sevir' else ast.literal_eval(args.thresholds)
args.value_scale = 255.0 if dataset_name == 'sevir' else 90.0
